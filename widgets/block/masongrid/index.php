...
class khobish_msngrid extends Widget_Base {
	...
	public function get_title() {
		return __( 'Masonry Grid', 'news-element' );
	}
	...
	protected function register_controls() {
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'default' => '33.33',
                 'selectors' => [
                        '{{WRAPPER}} .mason-on .masongrdgrid' => 'width: {{VALUE}}%;',
                 ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'type' =>  Controls_Manager::SLIDER,
                'selectors' => [
                    '{{WRAPPER}} .masongrdgrid' => 'padding-left: {{SIZE}}{{UNIT}};padding-right: {{SIZE}}{{UNIT}};',
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .bgholder' => 'text-align: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            'itbtspde',
            [
                'label' => __( 'Item bottom spacing', 'news-element' ),
                'type' =>  Controls_Manager::SLIDER,
                'selectors' => [
                    '{{WRAPPER}} .bgholder' => 'margin-bottom: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            'thmht',
            [
                'label' => __( 'Thumnail height', 'news-element' ),
                'type' =>  Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 0,
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .khboverlaythumb' => 'top: {{TOP}}{{UNIT}};left:{{LEFT}}{{UNIT}};position:absolute;',
                ]
            ]
        );
...
if ( defined( 'ELEMENTOR_VERSION' ) && version_compare( ELEMENTOR_VERSION, '3.5.0', '>=' ) ) {
    $widgets_manager->register(new \News_Element\Widgets\khobish_msngrid());
} else {
    $widgets_manager->register_widget_type(new \News_Element\Widgets\khobish_msngrid());
}
