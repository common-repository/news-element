	...
	protected function register_controls() {
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px'],
                'selectors' => [
                    '{{WRAPPER}} .bgholder' => 'height: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'type' =>  Controls_Manager::SLIDER,
                'selectors' => [
                    '{{WRAPPER}} .bgholder' => 'border-radius: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'default' => '33.33',
                 'selectors' => [
                        '{{WRAPPER}} .photonegrid' => 'width: {{VALUE}}%;',
                 ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'condition' => [
                 ...
                 'selectors' => [
                        '{{WRAPPER}} .photonegrid.khbsmgrid' => 'width: {{VALUE}}%;',
                 ],
            ]
        );
        $this->add_responsive_control(
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .metawrpr' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ]
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'type' =>  Controls_Manager::SLIDER,
                'selectors' => [
                    '{{WRAPPER}} .metawrpr' => 'bottom: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
