...
<div class="first-wrapper anim-fade">
<?php if( $wp_query->have_posts() ) :
  while( $wp_query->have_posts() ) :
      $wp_query->the_post();
      if( $i <= 0 ) :
      ?>
          <article class="khobish-flex-inr <?php echo Khobish_Helper::xl_post_format_icon();?>">
                  <div class="thumbwrp">
                ...
                <div class="excerpt-wrap"><div class="inr">
                  <?php Khobish_Helper::ae_build_postmeta($metaf,$excerptf);?></div>                        
